...
export const AdminPreview = () => {
  ...
  return (
    <div className="min-h-screen bg-[#faf8fb] flex">
      {/* Left Sidebar */}
      <div className="w-80 bg-white border-r border-[#e5e2e8] overflow-y-auto flex-shrink-0">
        <div className="sticky top-0 bg-white border-b border-[#e5e2e8] p-6 z-10">
          <h1 className="font-space-grotesk font-bold text-[20px] text-[#231821] mb-2">
      ...
      <div className="flex-1 overflow-y-auto p-8">
        <div className="max-w-[1000px] mx-auto space-y-6">
          ...
          <div className="bg-white rounded-lg border border-[#e5e2e8] shadow-sm p-8">
            <div className="flex gap-8 items-start">
              {/* Keycap Preview */}
              <div className="flex-shrink-0">
                <div
                  className="w-48 h-48 rounded border-2 p-2 flex items-center justify-center transition-all duration-300 hover:scale-105 cursor-pointer group relative"
                  style={{
              ...
              {/* Text Content */}
              <div className="flex-1">
                <h2 className="font-space-grotesk font-bold text-[28px] uppercase mb-2 text-[#231821]">
                  {result.nameEN}
                </h2>
                <h3 className="font-72-brand font-medium text-[20px] text-[#a800aa] mb-6">
                  {result.nameCN}
                </h3>
                ...
                {(result.mostLikelyToSayEN || result.mostLikelyToSayCN) && (
                  <div className="mt-4 pt-4 border-t border-[#e5e2e8]">
                    ...
                    <p className="font-space-grotesk text-[16px] text-[#231821]">
          ...
          >
            ...
            <p className="font-space-grotesk text-[18px] leading-relaxed text-[#231821]">
              "{language === 'zh' ? result.mottoCN : result.mottoEN}"
            </p>
            <p className="font-72-brand text-[14px] leading-relaxed text-[#534150] mt-2 opacity-70">
              {language === 'zh' ? result.mottoEN : result.mottoCN}
            </p>
          </div>

          {/* Signal */}
          <div className="bg-white rounded-lg border border-[#e5e2e8] shadow-sm p-6">
            ...
            <p className="font-space-grotesk text-[15px] leading-relaxed text-[#231821]">
          ...
          <div className="bg-white rounded-lg border border-[#e5e2e8] shadow-sm p-6">
            ...
            <p className="font-72-brand text-[15px] leading-relaxed text-[#231821] mb-4">
            ...
            >
              <p className="font-72-brand italic text-[14px] leading-relaxed text-[#534150]">
          ...
          {/* Risk */}
          <div className="bg-[rgba(255,218,214,0.1)] border border-[#ba1a1a] rounded-lg p-6">
            <div className="flex items-center gap-2 mb-4">
            ...
            <p className="font-72-brand text-[15px] leading-relaxed text-[#231821]">
          ...
          >
            ...
            <p className="font-space-grotesk font-bold text-[20px] leading-relaxed mb-3" style={{ color: punchlineTextColor }}>
              {language === 'zh' ? result.punchlineCN : result.punchlineEN}
            </p>
            <p className="font-72-brand italic text-[16px] leading-relaxed" style={{
          ...
          {(result.meetingBehaviorEN || result.meetingBehaviorCN) && (
            <div className="bg-white rounded-lg border border-[#e5e2e8] shadow-sm p-6">
              ...
              <p className="font-72-brand text-[15px] leading-relaxed text-[#231821] whitespace-pre-line">
